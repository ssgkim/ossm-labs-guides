...
[source,bash,subs="+macros,+attributes"]
----
kubectl delete virtualservice virtualservicename -n tutorial{namespace-suffix}
kubectl delete destinationrule destinationrulename -n tutorial{namespace-suffix}
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl replace -f istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml -n tutorial{namespace-suffix}
----
