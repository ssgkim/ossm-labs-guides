...
NOTE: The configs came from link:../lab-4/create-external-mtls-https-ingress-gateway.sh[<BROKEN FIX>create-external-mtls-https-ingress-gateway.sh] script which you can inspect for details.
...
NOTE: The configs came from link:../lab-4/deploy-external-travel-api-mtls-vs.sh[<BROKEN FIX>deploy-external-travel-api-mtls-vs.sh] script which you can inspect for details.
