...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f link:{github-repo}/{istiofiles-dir}/authorization-policy-deny-all.yaml[istiofiles/authorization-policy-deny-all.yaml] -n tutorial
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f link:{github-repo}/{istiofiles-dir}/authorization-policy-allow-customer.yaml[istiofiles/authorization-policy-allow-customer.yaml] -n tutorial
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f link:{github-repo}/{istiofiles-dir}/authorization-policy-allow-preference.yaml[istiofiles/authorization-policy-allow-preference.yaml] -n tutorial
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f link:{github-repo}/{istiofiles-dir}/authorization-policy-allow-recommendation.yaml[istiofiles/authorization-policy-allow-recommendation.yaml] -n tutorial
----
