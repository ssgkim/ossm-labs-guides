...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f <(istioctl kube-inject -f link:{github-repo}/{customer-repo}/kubernetes/Deployment_jvm.yml[{customer-repo}/kubernetes/Deployment_jvm.yml]) -n tutorial
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f <(istioctl kube-inject -f link:{github-repo}/{preference-repo}/kubernetes/Deployment_jvm.yml[{preference-repo}/kubernetes/Deployment_jvm.yml])  -n tutorial
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f <(istioctl kube-inject -f link:{github-repo}/{recommendation-repo}/kubernetes/Deployment_jvm.yml[{recommendation-repo}/kubernetes/Deployment_jvm.yml]) -n tutorial
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f <(istioctl kube-inject -f link:{github-repo}/{recommendation-repo}/kubernetes/Deployment-v2_jvm.yml[{recommendation-repo}/kubernetes/Deployment-v2_jvm.yml]) -n tutorial
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -f <(istioctl kube-inject -f link:{github-repo}/{recommendation-repo}/kubernetes/Deployment-v2.yml[{recommendation-repo}/kubernetes/Deployment-v2.yml]) -n tutorial
----
